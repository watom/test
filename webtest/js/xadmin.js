$(function () {
	...
	$("#allChk").click(function(){
		if(this.checked){
			...
			$("input[name='chk']").parent().parent().parent().addClass("select");
		}else{
			$("input[name='chk']").prop("checked", false);
			$("input[name='chk']").parent().parent().parent().removeClass("select");
		}
	});
	
	// 表格选中
	$(document).on('click', ".admin-table .form-checkbox label", function () {
...
/*
    ...
    h       弹出层高度（缺省调默认值）
*/
function x_admin_show(title,url,w,h,endCall){
    if (title == null || title == '') {
        title=false;
    };
    if (url == null || url == '') {
